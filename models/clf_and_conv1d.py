...
class Clf_and_Conv1d(Module):
    def __init__(self):
        ...
        self.conv3 = Conv1d(16, 32, (5, 5), (1, 1))
        ...
        self.linear5 = Linear(1024, 2048)
        self.linear5batchnorm = BatchNorm1d(2048)
        self.linear6 = Linear(2048, 1024)
        self.linear6batchnorm = BatchNorm1d(1024)
